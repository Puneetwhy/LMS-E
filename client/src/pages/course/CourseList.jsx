        ...
        {courseData?.length > 0 ? (
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {courseData.map((course) => (
              <div
                key={course._id}
                className="bg-white/10 backdrop-blur-md border border-gray-700 rounded-xl shadow-lg hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 overflow-hidden"
              >
