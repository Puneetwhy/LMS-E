      ...
      <div className="min-h-[90vh] flex items-center justify-center px-4 sm:px-10 py-16 text-white">
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-semibold rounded-md hover:scale-105 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
