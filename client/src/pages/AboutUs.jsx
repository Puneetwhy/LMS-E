...
const AboutUs = () => {
    return(
        <>
            <HomeLayout>
                <div className="pl-20 pt-20 min-h-[90vh] flex flex-col text-white">
                ...
                <div className="carousel w-full my-16 mx-auto">
                    <div id="item1" className="carousel-item flex flex-col items-center justify-center  w-full">
                        <img
                        src={Admin_Profile}
                        className="w-44 h-44 rounded-full m-7" />
                    ...
                    <div id="item4" className="carousel-item flex flex-col items-center justify-center w-full">
                        <img
                        src={girl_profile1}
                        className="w-44 h-44 rounded-full m-5" />
                ...
                <div className="flex w-full justify-center mb-5 gap-2 py-2">
